// components/Mascots.tsx — all Soli and Rive mascot/avatar components in one place.
// Platform: native (iOS/Android). The .web.tsx sibling provides the web variant.
...
// ── Tovi rive avatar (compact, for in-card use) ───────────────────────────
...
// ── Interactive icon set (Flash, Star, etc.) ──────────────────────────────
...
export function RiveIconSet({
  ...
  return (
    <View style={[riveStyles.iconContainer, { width: size, height: size }]} pointerEvents="none">
      <RiveView
        file={riveFile}
...
const riveStyles = StyleSheet.create({
  iconContainer: {
    alignItems: 'center',
    justifyContent: 'center',
  },
